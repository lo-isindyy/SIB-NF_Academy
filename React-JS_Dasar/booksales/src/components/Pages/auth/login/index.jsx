                    ...
                    <div className="modal-content rounded-4 shadow">
                        ...
                        <div className="modal-body p-5 pt-0">
                            <form>
                                ...
                                <button className="w-100 py-2 mb-2 btn btn-outline-secondary rounded-3 d-flex align-items-center justify-content-center gap-2" type="submit">
                                    <FaGoogle />
                                    Login with Google
                                </button>
                                <button className="w-100 py-2 mb-2 btn btn-outline-primary rounded-3 d-flex align-items-center justify-content-center gap-2" type="submit">
                                    <FaFacebookF />
                                    Login with Facebook
                                </button>
                                <button className="w-100 py-2 mb-2 btn btn-outline-secondary rounded-3 d-flex align-items-center justify-content-center gap-2" type="submit">
